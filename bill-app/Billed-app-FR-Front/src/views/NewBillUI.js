            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-half">
                    ...
                    <span data-testid="msgErrorFormat" id="msgErrorFormat" hidden>Merci de déposer un fichier au format image</span>
                  </div>
                </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="col-half">
                  <button type="submit" id='btn-send-bill' data-testid="btn-sub-newbill" class="btn btn-primary" disabled>Envoyer</button>
                </div>
              </div>
            </div>
          </form>
